...
| 이름 | 역할 |
|------|------|
| 최은혜 | 크롤링 개발, 자동화 파이프라인, DB 설계, NLP 기반 키워드 추출 및 분석, PM |
| 노주원 | 크롤링 개발, 데이터 전처리, EDA 및 트렌드 분석, README 관리 |
| 최소은 | 크롤링 개발, 데이터 시각화, EDA, 트렌드 분석,  문서화 |
| 탁홍진 | 크롤링 개발, 데이터 시각, EDA, 트렌드 분석, 문서화 |
---
